...
void correlate(int ny, int nx, const float *data, float *result) {
    ...
    std::vector<double8_t> padded(na * nx);
    #pragma omp parallel for
    ...
    for (int ja = 0; ja < na; ++ja) {
        ...
        for (int ia = ja; ia < na; ++ia) {
            ...
            double8_t vv010 = d8zero;
            double8_t vv011 = d8zero;
            double8_t vv100 = d8zero;
            double8_t vv101 = d8zero;
            double8_t vv110 = d8zero;
            ...
            double8_t vv[8] = { vv000, vv001, vv010, vv011, vv100, vv101, vv110, vv111 };
            ...
            for (int jb = 0; jb < 8; ++jb) {
                for (int ib = 0; ib < 8; ++ib) {
                    ...
                    int j = jb + ja*8;
                    if (i < ny && j < ny) {
                        result[i + j * ny] = (float) vv[ib^jb][jb];
                    }
                }
            }
        }
